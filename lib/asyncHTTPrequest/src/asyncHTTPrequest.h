...
class asyncHTTPrequest {
  ...
  struct  URL {
    ...
    typedef std::function<void(void*, asyncHTTPrequest*)> onBuildHeadersCB;
  ...
  public:
    ...
    void    onBuildHeaders(onBuildHeadersCB, void* arg = 0);        // notify for additional headers if required
